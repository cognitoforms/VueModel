    ...
    get allowedValuesRule(): AllowedValuesRule {
		...
		if (hasOwnProperty(this, "_allowedValuesRule")) {
            ...
            if (allowedValuesRule) {
                ...
                let allowedValuesRuleExistsHandler = SourcePathAdapter$_checkAllowedValuesRuleExists.bind(this);
...
function SourcePathAdapter$_checkAllowedValuesRuleExists<TEntity extends Entity, TValue>(this: SourcePathAdapter<TEntity, TValue>, rule: Rule) {
