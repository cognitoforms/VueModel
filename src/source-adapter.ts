...
import { EntityConstructor, ValueConstructor } from "@cognitoforms/model.js"; // eslint-disable-line import/no-duplicates

export type SourceType = ValueConstructor | EntityConstructor | ObjectConstructor;
