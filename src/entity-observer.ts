import { EntityAccessEventArgs, EntityChangeEventArgs } from "../lib/model.js/src/entity";
 ...
 */
export class EntityObserver extends CustomObserver implements ExtendedObserver {
