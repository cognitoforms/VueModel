...
// import { ObservableArrayMethods, ArrayChangedEventArgs, ArrayChangeType, ArrayChange } from "./types";

// /**
//  * Begin queueing changes to the array, make changes in the given callback function, then stop queueing and raise events
//  */
// function ObservableArray$batchUpdate<ItemType>(this: ObservableArray<ItemType>, fn: (array: ObservableArray<ItemType>) => void): void {
...
//  */
// function ObservableArray$copyWithin<ItemType>(this: ObservableArray<ItemType>, target: number, start?: number, end?: number): ItemType[] {
...
//  */
// function ObservableArray$fill<ItemType>(this: ObservableArray<ItemType>, value: ItemType, start?: number, end?: number): ItemType[] {
...
//  */
// function ObservableArray$pop<ItemType>(this: ObservableArray<ItemType>): ItemType | undefined {
...
//  */
// function ObservableArray$push<ItemType>(this: ObservableArray<ItemType>, ...items: ItemType[]): number {
// 	let originalLength = this.length;
// 	let newLength: number = Array.prototype.push.call(this, ...items);
// 	if (newLength > 0) {
...
//  */
// function ObservableArray$reverse<ItemType>(this: ObservableArray<ItemType>): ItemType[] {
...
//  * @returns The removed element from the array; undefined if the array is empty.
//  */
// function ObservableArray$shift<ItemType>(this: ObservableArray<ItemType>): ItemType | undefined {
// 	let originalLength = this.length;
...
//  */
// function ObservableArray$sort<ItemType>(this: ObservableArray<ItemType>): ItemType[] {
...
//  */
// function ObservableArray$splice<ItemType>(this: ObservableArray<ItemType>, start: number, deleteCount?: number, ...items: ItemType[]): ItemType[] {
...
//  * @returns The new length property of the object upon which the method was called.
//  */
// function ObservableArray$unshift<ItemType>(this: ObservableArray<ItemType>, ...items: ItemType[]): number {
// 	let originalLength = this.length;
...
//  */
// export function ObservableArray$overrideNativeMethods<ItemType>(this: Array<ItemType> | ObservableArray<ItemType>): void {
...
// export class ObservableArray<ItemType> extends Array<ItemType> implements ObservableArrayMethods<ItemType> {
...
// 			array = items;
// 		else
// 			array = new ObservableArray(...items);
...
// 	 */
// 	private constructor(...items: ItemType[]) {
// 		super(...items);
...
// 		if (this.constructor !== ObservableArray) {
