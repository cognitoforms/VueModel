...
function Array$indexOf(array, item) {
...
var observableListMarkerField = "_oL" + randomText(3, false, true);
...
var ObservableListMethods = /** @class */ (function () {
    ...
    ObservableListMethods.add = function (list, item) {
        ...
        list._changedEvent.publish(list, { added: added, addedIndex: addedIndex, removed: [], removedIndex: -1 });
    };
    /**
    ...
    ObservableListMethods.remove = function (list, item) {
        ...
        if (removedIndex !== -1) {
            ...
            list._changedEvent.publish(list, { added: [], addedIndex: -1, removed: removed, removedIndex: removedIndex });
            return true;
        }
    };
...
var ObservableListImplementation = /** @class */ (function (_super) {
    ...
    function ObservableListImplementation(items) {
        ...
        if (_this.constructor === ObservableListImplementation) {
            ObservableListImplementation._initFields(_this);
            ObservableList._markObservable(_this);
        }
        else {
            ObservableListImplementation.implementObservableList(_this);
        }
        return _this;
    }
...
function Property$_subListEvents(obj, property, list) {
    list.changed.subscribe(function (args) {
        if ((args.added && args.added.length > 0) || (args.removed && args.removed.length > 0)) {
            ...
            var eventArgs = { entity: obj, property: property, newValue: list };
...
function Property$_setValue(property, obj, old, val, additionalArgs) {
    ...
    if (property.isList) {
        ...
        // Do not raise change if the property has not been initialized. 
        if (old !== undefined) {
            var eventArgs = { entity: obj, property: property, newValue: val, oldValue: old };
...
var ConditionType = /** @class */ (function () {
    ...
    */
    function ConditionType(code, category, message, sets, origin) {
        ...
        // this.rules = [];
        this.conditions = ObservableList.create();
        this.sets = sets || [];
        this.origin = origin;
...
var ConditionRule = /** @class */ (function (_super) {
    ...
    function ConditionRule(rootType, options, skipRegistration) {
        ...
        Object.defineProperty(_this, "conditionType", {
        ...
        if (options.message) {
            Object.defineProperty(_this, "message", { value: options.message, writable: true });
        }
        Object.defineProperty(_this, "properties", { value: options.properties || [], writable: true });
        if (!skipRegistration) {
            // Register the rule after loading has completed
    ...
    Object.defineProperty(ConditionRule.prototype, "properties", {
    ...
    Object.defineProperty(ConditionRule.prototype, "message", {
    ...
    ConditionRule.prototype.execute = function (obj, args) {
        ...
        if (assert !== undefined) {
            this.conditionType.when(assert, obj, this.properties instanceof Function ? this.properties(obj) : this.properties, message);
        }
    };
...
var ValidatedPropertyRule = /** @class */ (function (_super) {
    ...
    ValidatedPropertyRule.prototype.assert = function (obj) {
        var isValid = this._isValid(obj, this.property, this.property.value(obj));
...
export { intrinsicJsTypes, Model, ModelEvents, ModelSettings, Model$whenTypeAvailable, Model$getJsType, Model$getPropertyOrPropertyChain, Type$newIdPrefix, Type, TypeEvents, Type$_generateConstructor, Property, PropertyEvents, Property$_generateShortcuts, Property$_generateStaticProperty, Property$_generatePrototypeProperty, Property$_generateOwnProperty, Property$_generateOwnPropertyWithClosure, Property$getRules, Property$pendingInit, Property$addAccessed, Property$addChanged, hasPropertyChangedSubscribers, PropertyChain, PropertyChain$create, PropertyChainEvents, PropertyChain$_addAccessedHandler, PropertyChain$_addChangedHandler, Entity, EntityEvents, Entity$toIdString, Entity$fromIdString, ObjectMeta, ObjectMetaEvents, Format, PathTokens, PathTokens$normalizePaths, ConditionTarget, ConditionTypeSet, ConditionTypeSetEvents, ConditionType, ConditionTypeEvents, ErrorConditionType, WarningConditionType, PermissionConditionType, Condition, FormatError, FormatError$getConditionType, Rule, registerPropertyRule, Rule$ensureConditionType, RuleInvocationType, ConditionRule, ValidatedPropertyRule, AllowedValuesRule, CalculatedPropertyRule };
